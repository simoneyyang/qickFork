...
VL_INLINE_OPT VlCoroutine Vdac_top_tb_mem___024root___eval_initial__TOP__Vtiming__0(Vdac_top_tb_mem___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((0U == vlSelfRef.dac_top_tb_mem__DOT__f_log_out)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: dac_top_tb_mem.sv:79: Assertion failed in %Ndac_top_tb_mem: Failed to open log file: top_dac_mem.csv\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("dac_top_tb_mem.sv", 79, "", false);
    }
    ...
    vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__i = 0U;
    while (VL_GTS_III(32, 0x640U, vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__i)) {
        ...
        vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__unnamedblk2__DOT__current_stim 
            = ((0x63fU >= (0x7ffU & vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__i))
                ? vlSelfRef.dac_top_tb_mem__DOT__stim_memory
               [(0x7ffU & vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__i)]
                : 0U);
        ...
        vlSelfRef.dac_top_tb_mem__DOT__data_16bit_for_logger 
            = vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__unnamedblk2__DOT__data_from_mem;
        vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__i 
            = ((IData)(1U) + vlSelfRef.dac_top_tb_mem__DOT__unnamedblk1__DOT__i);
    }
    vlSelfRef.dac_top_tb_mem__DOT__s_axis_tvalid = 0U;
    vlSelfRef.dac_top_tb_mem__DOT__log_enable = 0U;
    ...
    VL_FCLOSE_I(vlSelfRef.dac_top_tb_mem__DOT__f_log_out); VL_FINISH_MT("dac_top_tb_mem.sv", 119, "");
    vlSelfRef.__Vm_traceActivity[2U] = 1U;
}
