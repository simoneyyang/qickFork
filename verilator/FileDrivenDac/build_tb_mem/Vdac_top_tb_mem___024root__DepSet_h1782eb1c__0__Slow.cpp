...
VL_ATTR_COLD void Vdac_top_tb_mem___024root____Vm_traceActivitySetAll(Vdac_top_tb_mem___024root* vlSelf);
...
VL_ATTR_COLD void Vdac_top_tb_mem___024root___eval_stl(Vdac_top_tb_mem___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vdac_top_tb_mem___024root____Vm_traceActivitySetAll(vlSelf);
    }
}
...
VL_ATTR_COLD void Vdac_top_tb_mem___024root____Vm_traceActivitySetAll(Vdac_top_tb_mem___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdac_top_tb_mem___024root____Vm_traceActivitySetAll\n"); );
    Vdac_top_tb_mem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vdac_top_tb_mem___024root___ctor_var_reset(Vdac_top_tb_mem___024root* vlSelf) {
    ...
    vlSelf->dac_top_tb_mem__DOT__unnamedblk1__DOT__i = 0;
    ...
    vlSelf->dac_top_tb_mem__DOT__dut__DOT__unnamedblk1__DOT__j = 0;
